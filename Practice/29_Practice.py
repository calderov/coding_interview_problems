...
#   Output: 3
#   Explanation: The cars starting at 10 (speed 2) and 8 (speed 4) become a fleet, meeting
#                each other at 12.
#
...
#   Output: 1
#   Explanation: The cars starting at 0 (speed 4) and 2 (speed 2) become a fleet, meeting
...
class Solution:
    ...
    def carFleet(self, target, position, speed):
        ...
        for p, s in cars:
            ...
            if time_to_target > bottleneck:
                bottleneck = time_to_target
                fleets += 1
