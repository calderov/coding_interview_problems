...
class Solution:
    ...
    def TripletsWithSmallerSum(self, nums, targetSum):
        tripletsCount = 0
        n = len(nums)
        for i in range(n):
            for j in range(n):
    ...
    def TripletsWithSmallerSumV2(self, nums, targetSum):
        nums.sort()
        n = len(nums)
        tripletsCount = 0
        for i in range(n - 2):
    ...
    def TripletsWithSmallerSum(self, nums, targetSum):
        return self.TripletsWithSmallerSumV2(nums, targetSum)
...
if __name__ == "__main__":
    ...
    nums = [-1, 0, 2, 3]
    targetSum = 3
    expectedOutput = 2 # Explanation: There are two triplets whose sum is less than the target: [-1, 0, 3], [-1, 0, 2]
    output = solution.TripletsWithSmallerSum(nums, targetSum)
    print(output, expectedOutput, output == expectedOutput)

    # Example 2
    nums = [-1, 4, 2, 1, 3]
    targetSum = 5
    expectedOutput = 4 # Explanation: There are four triplets whose sum is less than the target: [-1, 1, 4], [-1, 1, 3], [-1, 1, 2], [-1, 2, 3]
    output = solution.TripletsWithSmallerSum(nums, targetSum)
    print(output, expectedOutput, output == expectedOutput)
    ...
    nums = [0, 0, 0, 0, 0]
    targetSum = 1
    expectedOutput = 10 # Explanation: There are four triplets whose sum is less than the target: [-1, 1, 4], [-1, 1, 3], [-1, 1, 2], [-1, 2, 3]
    output = solution.TripletsWithSmallerSum(nums, targetSum)
    print(output, expectedOutput, output == expectedOutput)