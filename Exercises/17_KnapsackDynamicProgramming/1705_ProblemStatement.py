...
class Solution:
    ...
    #
    # Once the table is populated, return the value stored in the last cell of the table, as it contains how many subsets add to S.
    #
    # Solution complexity:
...
if __name__ == "__main__":
    ...
    s = 4
    expectedOutput = 3
    output = solution.TotalNumberOfSubsetsWithSumS(nums, s)
